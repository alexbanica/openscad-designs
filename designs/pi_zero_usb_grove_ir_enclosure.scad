...
pod_cap_insert_keeper_cap_diameter_mm = 3.55;
pod_cap_insert_keeper_cap_thickness_mm = 1.0;
...
pod_attachment_post_keeper_cap_diameter_mm = 5.0;
pod_attachment_post_keeper_cap_thickness_mm = 1.0;
