...
Implement the approved Raspberry Pi AI HAT+ 26T PCIe connector correction, README documentation update, and validation required by the approved spec.
...
- `designs/rpi5_ai_hat_plus_26t.scad`: remove the incorrect hanging/off-board PCIe guidance geometry and replace it with left-side on-board PCIe connector/routing reference geometry.
- `README.md`: document that PCIe guidance is a left-side on-board connector/routing reference, not a separate hanging device.
...
5. Update `README.md`.
   - In the Raspberry Pi AI HAT+ 26T section, document that PCIe guidance is a left-side on-board connector/routing reference.
...
7. Main-agent QA.
   ...
   - Confirm:
     ...
     - PCIe connector/guidance sits on the left part of the AI HAT+ PCB,
...
- README must document the PCIe guidance as a left-side on-board connector/routing reference and not as a separate hanging device.
