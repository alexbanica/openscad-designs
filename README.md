...
- The pod uses cap-owned male insert pins and pod-body socket holes for closure, which are distinct from the cover-to-tray pin/socket interface and pod-to-cover post/socket interface.
