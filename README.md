...
- The pod uses cap-owned male insert pins and side-wall receiver sleeves/socket bosses for closure, keeping the pod center clear for PCB insertion. These features are distinct from the cover-to-tray pin/socket interface and pod-to-cover post/socket interface.
