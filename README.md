...
- The pod uses cap-owned male insert pins and pod-body-visible receiver sleeves/socket bosses for closure, which are distinct from the cover-to-tray pin/socket interface and pod-to-cover post/socket interface.
