...
- Side USB-A connector depth runs along X and width runs along Y; each port mouth outer face aligns to the corresponding +/-X board face, with connector bodies extending inward over the PCB.
