...
- The cap insert interface uses reinforced pin roots with straight male pins and straight socket bores. The prior two-stage retention shoulder/interference section is removed so insertion is not blocked by a tight retention step.
- Use PLA, PETG, or another material appropriate for the target thermal environment.
